...
<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            {{-- Real-Time Feed Control --}}
            <li class="{{ setSidebarActive(['admin.realtime-feed.*']) }}">
                <a href="{{ route('admin.realtime-feed.index') }}" class="nav-link">
            ...
            <li class="dropdown {{ setSidebarActive(['admin.aggregator.*', 'admin.dashboard.advanced']) }}">
                <a href="#" class="nav-link has-dropdown"><i class="fas fa-rss"></i>
                    <span>News Aggregator</span></a>
                <ul class="dropdown-menu">
                    <li class="{{ setSidebarActive(['admin.aggregator.index']) }}"><a class="nav-link"
                            href="{{ route('admin.aggregator.index') }}"><i class="fas fa-satellite-dish"></i> News Sources</a></li>
                    <li class="{{ setSidebarActive(['admin.aggregator.news']) }}"><a class="nav-link"
                            href="{{ route('admin.aggregator.news') }}"><i class="fas fa-newspaper"></i> Aggregated News</a></li>
                    <li class="{{ setSidebarActive(['admin.dashboard.advanced']) }}"><a class="nav-link"
                            href="{{ route('admin.dashboard.advanced') }}"><i class="fas fa-chart-line"></i> Source Analytics</a></li>
                </ul>
            </li>
