...
<section class="section">
    <div class="section-header">
        <h1><i class="fas fa-plus mr-2"></i>{{ __('admin.Add News Source') }}</h1>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.aggregator.store') }}" method="POST">
                        @csrf
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" 
                                           value="{{ old('name') }}" required placeholder="e.g., BBC News">
                                    @error('name')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="country" id="country" class="form-control @error('country') is-invalid @enderror" 
                                           value="{{ old('country') }}" placeholder="e.g., UK">
                                    @error('country')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="language" id="language" class="form-control @error('language') is-invalid @enderror" 
                                           value="{{ old('language') }}" placeholder="e.g., en">
                                    @error('language')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="api_type" id="api_type" class="form-control @error('api_type') is-invalid @enderror" required>
                                        ...
                                        <option value="rest" {{ old('api_type') == 'rest' ? 'selected' : '' }}>REST API</option>
                                        <option value="rss" {{ old('api_type') == 'rss' ? 'selected' : '' }}>RSS Feed</option>
                                    </select>
                                    @error('api_type')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="url" name="api_endpoint" id="api_endpoint" class="form-control @error('api_endpoint') is-invalid @enderror" 
                                           value="{{ old('api_endpoint') }}" required placeholder="https://api.example.com/news">
                                    @error('api_endpoint')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="api_key" id="api_key" class="form-control @error('api_key') is-invalid @enderror" 
                                           value="{{ old('api_key') }}" placeholder="Your API key if required">
                                    @error('api_key')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="url" name="rss_feed_url" id="rss_feed_url" class="form-control @error('rss_feed_url') is-invalid @enderror" 
                                           value="{{ old('rss_feed_url') }}" placeholder="https://example.com/feed.xml">
                                    @error('rss_feed_url')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="fetch_interval" id="fetch_interval" class="form-control @error('fetch_interval') is-invalid @enderror" 
                                           value="{{ old('fetch_interval', 30) }}" min="1">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="priority" id="priority" class="form-control @error('priority') is-invalid @enderror" 
                                           value="{{ old('priority', 3) }}" min="1" max="5">
                                    @error('priority')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="credibility_score" id="credibility_score" class="form-control @error('credibility_score') is-invalid @enderror" 
                                           value="{{ old('credibility_score', 85) }}" min="0" max="100">
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save mr-2"></i>Create News Source
                            </button>
